...
const MobileNavExitButton = (props) => (
  <FontAwesomeIcon
    icon={faXmark}
    onClick={props.onClick}
    css={css`
...
const MobileNavOverlay = styled((props) => (
  <motion.div
...
export default function Nav() {
  ...
  const closeNavOverlay = () => {
    ...
    setTimeout(
      () => setMobileNavOverlayEnabled(false),
      MOBILE_NAV_TRANSITION_TIME * 1000
    );
  };
  ...
  return (
    <>
      ...
      >
        <MobileNavExitButton onClick={closeNavOverlay} />
        <MobileNavSection onClick={closeNavOverlay} to="/products" text="BROWSE" />
        <MobileNavSection onClick={closeNavOverlay} to="/whyus" text="WHY US?" />
        <MobileNavSection onClick={closeNavOverlay} to="/contact" text="CONTACT US" />
      </MobileNavOverlay>
      <Wrapper
        style={{
          paddingTop: "70px",
